...
function getData(obj) {
    ...
    let email = obj.children[5].innerHTML;
    let phone = obj.children[6].innerHTML;
    let address = obj.children[7].innerHTML;
    ...
    document.getElementById('iemailm').value = email;
    document.getElementById('iphonem').value = phone;
    document.getElementById('iaddressm').value = address;
