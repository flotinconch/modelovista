    ...
    <section class="content">
          ...
          <div class="row">
              <div class="col-lg-6 col-xs-6">
                ...
                <div class="input-group">
                  ...
                  <input id="iemail" name="iemail" type="text" class="form-control">
                </div>
              </div>
              <!-- ./col -->
              <div class="col-lg-6 col-xs-6">
                ...
                <div class="input-group">
                  ...
                  <input id="iphone" name="iphone" type="number" class="form-control">
                </div>
              </div>
            </div>
          <br>
          ...
          <div class="row">
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="input-group">
                ...
                <input id="iaddress" name="iaddress" type="text" class="form-control">
              </div>
            </div>
        <!-- /.box-body -->
      ...
      <?php
        if (isset($_POST['iname'])){
          ...
          $objCtrUser -> setInsertUser($_POST['iname'], $_POST['iape'], $_POST['iuser'], $_POST['icontra'], $_POST['iemail'], $_POST['iphone'], $_POST['iaddress']);
        }
      ?>
      ...
      <div class="modal-content">
        ...
        <div class="row">
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="input-group">
                <span class="input-group-addon">email</span>
                <input id="iemailm" name="iemailm" type="text" class="form-control">
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="input-group">
                <span class="input-group-addon">phone</span>
                <input id="iphonem" name="iphonem" type="number" class="form-control">
              </div>
            </div>
          </div>
        <br>
        ...
        <div class="row">
          <div class="col-lg-6 col-xs-6">
            ...
            <div class="input-group">
              <span class="input-group-addon">address</span>
              <input id="iaddressm" name="iaddressm" type="text" class="form-control">
            </div>
          </div>
        </form>
        </div>
